            ...
            <x-dashboard-header>
                <div class="flex items-center gap-4 flex-grow max-w-xl">
                    <div class="relative w-full">
                        ...
                        <input data-search-input type="text" placeholder="Search staff..."
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-xs">
                            ...
                            <tbody class="divide-y" data-search-results>
                                @include('users.teachers.partials.rows', ['teachers' => $teachers])
                            </tbody>
                        </table>
                    </div>
                </div>
                <div class="flex justify-center mt-4" data-search-pagination>
                    @include('users.teachers.partials.pagination', ['teachers' => $teachers])
                </div>
            </div>
        </div>
    </main>
