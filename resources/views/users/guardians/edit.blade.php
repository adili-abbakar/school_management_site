    ...
    <main class="flex-grow flex flex-col min-w-0  overflow-y-auto">
        ...
        <div class="p-4 md:p-6">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3">
                <div>
                    <h1 class="text-xl font-extrabold text-primary">Edit Existing Guardian</h1>
                    <p class="text-slate-500 text-xs">Edit exsiting guardian/parent to the system.</p>
                </div>
            ...
            <form class="form bg-white rounded-xl border border-slate-100 shadow-sm p-4 md:p-6" method="POST"
                action="{{ route('guardians.update', $guardian->user_id) }}">
                @csrf
                @method('PUT')
                @include('users.guardians.partials.form-fields', ['guardian' => $guardian])
                ...
                <div class="flex flex-wrap gap-3 pt-6 border-t border-slate-100">
                    <button type="submit"
                        ...
                        <span>Update Guardian Account</span>
                    </button>
                    
                    <a href="{{ route('user.edit-password', $guardian->user->id) }}"
                        ...
                        <span>Edit Guardian Password</span>
