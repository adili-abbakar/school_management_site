...
@section('page-content')
 ...
 <div class="max-w-md w-full">
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center p-3 bg-blue-900 text-white rounded-2xl mb-4 shadow-xl shadow-blue-900/20">
            ...
            <form action="dashboard.html" class="space-y-5">
                ...
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <a href="{{ route('forgot-password') }}" class="text-[10px] font-bold text-blue-600 hover:text-blue-800 uppercase tracking-wider">Forgot?</a>
                    </div>
                    <div class="relative">
                ...
                <div class="flex items-center gap-2">
                    <input type="checkbox" id="remember" class="w-3.5 h-3.5 rounded border-gray-300 text-blue-900 focus:ring-blue-900">
                    <label for="remember" class="text-xs text-gray-600">Remember me for 30 days</label>
                </div>

                <button type="submit" class="w-full bg-blue-900 text-white py-3 rounded-xl font-bold text-sm hover:bg-blue-800 shadow-lg shadow-blue-900/20 transition-all flex items-center justify-center gap-2">
