...
@section('page-content')
    <main class="flex-grow flex flex-col min-w-0  overflow-y-auto">
        ...
        <div class="p-6">
            <div class="mb-6">
                <x-buttons.blue-back-link>To Sections</x-buttons.blue-back-link>
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                <form class="form space-y-6" action="{{ route('sections.store') }}" method="POST">
                    @csrf


                    @include('academic.sections.partials.section-form-fields')
