  @forelse ($programs as $section)
      <div class="session-card bg-white rounded-lg border border-slate-200 p-6 hover:shadow-lg">
          <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
              <div>
                  <h2 class="text-primary font-semibold text-lg mb-1">{{ $section->name }} Academic Program
                  </h2>
              ...
              <div class="flex gap-2 flex-wrap">
                  <a href="{{ route('programs.levels.create', $section) }}"
                  ...
                  @forelse ($section->levels as $level)
                      <div class="bg-gradient-to-br  from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
                          ...
                          <div class="mt-3 flex gap-2">
                              <a href="{{ route('programs.levels.edit', [$section, $level]) }}"
                              ...
                              <a href="{{ route('programs.levels.delete', [$section, $level]) }}"
