...
@section('title', 'Create Numbering Setting')
    ...
    <main class="flex-grow flex flex-col min-w-0 overflow-y-auto">
        ...
        <div class="p-4 md:p-6">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3">
                <div>
                    <h1 class="text-xl font-extrabold text-primary">Create Numbering Pattern</h1>
            ...
            <!-- Form -->
            <form action="{{ route('numbering-settings.store') }}" method="POST"
                class="form bg-white rounded-xl border border-slate-100 shadow-sm p-4 md:p-6">
                @csrf

                @include('numbering-settings.partials.form-feilds')
