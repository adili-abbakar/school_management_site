    ...
    <main class="flex-grow">
        ...
        <section class="container mx-auto px-4 pb-20">
            <div class="max-w-5xl mx-auto">
                <form action="#" class="space-y-8 bg-white p-8 md:p-12 rounded-xl border border-gray-200 shadow-sm"
                    data-aos="fade-up">
                    <!-- Student Details -->
                    <section>
                    ...
                    <section>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div>
                                <label class="form-label">Guardian Full Name
                                    <span class="text-red-500">*</span></label>
        ...
        <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div>
                ...
                <ul class="space-y-2 text-xs text-gray-300">
                    <li>
                        <a href="about.html" class="hover:text-[#6B8DD6] transition-colors">Our Story</a>
                    </li>
                    <li>
                        <a href="#" class="hover:text-[#6B8DD6] transition-colors">Programs</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul class="space-y-2 text-xs text-gray-300">
                    <li>
                        <a href="#" class="hover:text-[#6B8DD6] transition-colors">Primary School</a>
                    </li>
                    <li>
                        <a href="#" class="hover:text-[#6B8DD6] transition-colors">Secondary School</a>
                    </li>
                </ul>
            </div>
            <div>
