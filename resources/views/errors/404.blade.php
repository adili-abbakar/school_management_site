...
@section('content')
    <div class="bg-white/80 backdrop-blur-md border border-white/60 shadow-xl rounded-3xl p-8 md:p-12 text-center">
        <div class="w-16 h-16 mx-auto mb-6 rounded-full bg-blue-50 flex items-center justify-center">
            <i class="fas fa-map-signs text-blue-600 text-2xl"></i>
        </div>

        <h1 class="text-7xl font-extrabold text-slate-900 mb-3">404</h1>
